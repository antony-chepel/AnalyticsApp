...
import com.tony_fire.googleanalyticsapp.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun videoPlayer() {
        ...
        val mediaItem: MediaItem = MediaItem.fromUri("http://yuanpay.online/googanal/goog.mp4.m3u8")
