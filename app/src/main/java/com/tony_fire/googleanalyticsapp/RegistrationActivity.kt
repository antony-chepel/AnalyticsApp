...
import com.retrofit.InfoClass
import com.retrofit.RetrofitInstance
import com.retrofit.UserInfo
import com.tony_fire.googleanalyticsapp.R
import com.tony_fire.googleanalyticsapp.databinding.ActivityRegistrationBinding
...
class RegistrationActivity : AppCompatActivity() {
    ...
    private fun userField() {
       binding.regButton.setOnClickListener {
            ...
            val userinfo = UserInfo(countrypicker,ed_email,ed1stName,"5ffc3fdf688bb134e6c1e720",ed2stName,ed_tel,"gjbkyit")
            ...
            call.enqueue(object : Callback<InfoClass> {
                    ...
                    if(response.isSuccessful){
                        ...
                        when {
                            ...
                            response.body()?.data?.pr.equals("exist") -> {
                                Toast.makeText(this@RegistrationActivity,"Вы уже зарегестрированы!",Toast.LENGTH_LONG).show()
                            }
                ...
                override fun onFailure(call: Call<InfoClass>, t: Throwable) {
                    Toast.makeText(applicationContext,"Проверьте соединение к интернету", Toast.LENGTH_SHORT).show()
                }
